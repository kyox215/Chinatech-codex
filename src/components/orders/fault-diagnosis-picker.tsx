  ...
  return (
    <div
      ...
      className={cn(
        ...
        compact
          ? compactColumns === 4
            ? "order-fault-category-grid-four auto-rows-fr gap-1"
...
function CompactFaultCategory({
  ...
  const trigger = (
    <button
      ...
      className="grid min-h-11 min-w-11 self-stretch place-items-center border-l border-[var(--border-panel)] hover:bg-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
    ...
    <>
      <Popover open={open && desktop} onOpenChange={changeOpen}>
        <div
          ...
          className={cn(
            "grid min-h-11 min-w-0 grid-cols-[minmax(0,1fr)_2.75rem] overflow-hidden rounded-md border",
            active.length
        ...
        >
          <button
            ...
            className="flex min-h-11 min-w-0 items-center gap-0.5 px-0.5 py-1.5 text-left text-[11px] font-medium leading-[14px] hover:bg-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring min-[390px]:text-xs min-[390px]:leading-[14px]"
          >
            {active.length ? (
              <Check
