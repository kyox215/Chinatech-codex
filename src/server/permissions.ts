...
export const permissionActions = [
  ...
  "reservation:create",
  "payment:refund_adjust",
  "pickup:confirm",
  "pickup:override_balance",
  "warranty:adjust",
  "after_sales:intake",
  "after_sales:update",
...
export const permissionActionDefinitions: Record<PermissionAction, PermissionActionDefinition> = {
  ...
  "inventory:inspection": { label: "录入商品设备检测", requiresStore: true },
  "reservation:create": { label: "创建商品预订", requiresStore: true, auditRequired: true },
  "payment:refund_adjust": {
    label: "商品付款退款或冲正",
    requiresStore: true,
    auditRequired: true,
  ...
  "pickup:confirm": { label: "确认商品取走", requiresStore: true, auditRequired: true },
  "pickup:override_balance": {
    label: "余额未清强制交付商品",
    requiresStore: true,
    auditRequired: true,
  ...
  "after_sales:intake": { label: "登记商品售后", requiresStore: true, auditRequired: true },
  "after_sales:update": { label: "推进商品售后", requiresStore: true, auditRequired: true },
  "buyback:quote_create": {
    label: "创建回收透明报价",
    requiresStore: true,
    auditRequired: true,
...
export const rolePermissions: RolePermissionMatrix = {
  owner: {
    ...
    "inventory:inspection": allow,
    "reservation:create": allow,
    "payment:refund_adjust": allow,
    "pickup:confirm": allow,
    "pickup:override_balance": allow,
    "warranty:adjust": allow,
    "after_sales:intake": allow,
    "after_sales:update": allow,
  ...
  technician: {
    ...
    "inventory:cost_allocate": deny,
    "inventory:inspection": allow,
    "reservation:create": deny,
    "payment:refund_adjust": deny,
    "pickup:confirm": deny,
    "pickup:override_balance": deny,
    "warranty:adjust": deny,
    "after_sales:intake": allow,
    "after_sales:update": allow,
