...
export const permissionActions = [
  ...
  "buyback:quote_create",
  "buyback:quote_revise",
  "buyback:quote_respond",
...
export const rolePermissions: RolePermissionMatrix = {
  owner: {
    ...
    "buyback:quote_create": allow,
    "buyback:quote_revise": allow,
    "buyback:quote_respond": allow,
  ...
  technician: {
    ...
    "inventory:legacy_import": deny,
    "inventory:cost_allocate": deny,
    "buyback:quote_create": deny,
    "buyback:quote_revise": deny,
    "buyback:quote_respond": deny,
