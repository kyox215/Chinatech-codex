...
const faultItalianTerms: Record<string, string> = {
  ...
  黑屏无显示: "Schermo nero",
  "花屏/竖线": "Linee sul display",
  背光异常: "Retroilluminazione difettosa",
  贴膜服务: "Applicazione pellicola",
  电池: "Batteria",
  健康度低: "Salute batteria bassa",
  耗电快: "Consumo rapido",
  鼓包: "Batteria gonfia",
  自动关机: "Spegnimento improvviso",
  电池不识别: "Batteria non riconosciuta",
  充电慢: "Ricarica lenta",
  电池校准: "Calibrazione batteria",
  尾插: "Connettore di ricarica",
  接口松动: "Porta allentata",
  无法充电: "Non carica",
  清洁尾插: "Pulizia connettore",
  接触不良: "Contatto intermittente",
  快充异常: "Ricarica rapida difettosa",
  无法连接电脑: "Connessione dati non funziona",
  无线充异常: "Ricarica wireless difettosa",
  摄像头: "Fotocamera",
  前摄异常: "Fotocamera frontale",
  后摄异常: "Fotocamera posteriore",
  镜头破损: "Lente danneggiata",
  无法对焦: "Messa a fuoco non funziona",
  抖动异响: "Vibrazione della fotocamera",
  闪光灯异常: "Flash non funzionante",
  相机打不开: "App fotocamera non si apre",
  进水: "Danni da liquido",
  清洁检测: "Pulizia e diagnosi",
  主板腐蚀: "Ossidazione scheda",
  进水不开机: "Non si accende dopo liquido",
  进水屏幕异常: "Display danneggiato da liquido",
  资料抢救: "Recupero dati",
  进水检测报告: "Report diagnosi liquido",
  主板: "Scheda madre",
  不开机: "Non si accende",
  无服务: "Nessun servizio",
  短路: "Corto circuito",
  充电IC: "IC ricarica",
  电源IC: "IC alimentazione",
  "Wi-Fi/蓝牙异常": "Wi-Fi/Bluetooth difettoso",
  "硬盘/存储故障": "Memoria interna difettosa",
  主板维修: "Riparazione scheda madre",
  系统: "Sistema",
  刷机恢复: "Ripristino software",
  资料迁移: "Trasferimento dati",
  账户问题: "Problema account",
  屏幕锁解锁: "Sblocco codice schermo",
  "PIN/图案解锁": "Sblocco PIN o sequenza",
  系统升级: "Aggiornamento sistema",
  资料备份: "Backup dati",
  激活锁核验咨询: "Verifica blocco attivazione",
  "软件/应用异常": "Problema app o software",
  后盖: "Cover posteriore",
  玻璃破裂: "Vetro posteriore rotto",
  中框变形: "Telaio deformato",
  摄像头玻璃: "Vetro fotocamera",
  无线充线圈: "Bobina ricarica wireless",
  后壳总成: "Scocca posteriore completa",
  防水胶重贴: "Nuova guarnizione adesiva",
  "面容/指纹": "Face ID / Impronta",
  面容异常: "Face ID non funzionante",
  指纹异常: "Impronta non funzionante",
  距离感应异常: "Sensore prossimita difettoso",
  自动亮度异常: "Sensore luminosita difettoso",
  "Home 指纹键": "Tasto Home con impronta",
  听筒排线: "Flat altoparlante auricolare",
  扬声器: "Altoparlante",
  声音小: "Volume basso",
  杂音: "Rumore",
  外放无声: "Altoparlante senza audio",
  听筒无声: "Auricolare senza audio",
  听筒网清洁: "Pulizia griglia auricolare",
  扬声器更换: "Sostituzione altoparlante",
  麦克风: "Microfono",
  无声: "Audio assente",
  通话杂音: "Rumore in chiamata",
  对方听不到: "Interlocutore non sente",
  录音异常: "Registrazione difettosa",
  底部麦克风: "Microfono inferiore",
  顶部麦克风: "Microfono superiore",
  麦克风清洁: "Pulizia microfono",
  按键: "Tasti",
  电源键: "Tasto accensione",
  音量键: "Tasti volume",
  静音键: "Tasto silenzioso",
  "Home 键": "Tasto Home",
  "Action 按键": "Tasto Azione",
  相机控制键: "Tasto controllo fotocamera",
  震动马达: "Motore vibrazione",
  按键排线: "Flat tasti",
  不细分: "",
};
