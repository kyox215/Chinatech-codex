...
export function buildEditForm(data: OrderDetail, defaultWarrantyMonths = 6): UpdateOrderInput {
  ...
  return {
    ...
    intake_intent_selection: order.intake_intent_selection,
    reported_symptoms_selection: order.reported_symptoms_selection,
    diagnostic_findings_selection: order.diagnostic_findings_selection,
