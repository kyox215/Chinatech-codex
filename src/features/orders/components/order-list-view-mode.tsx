        ...
        return (
          <Button
            ...
            className={cn(
              ...
              compact &&
                "h-8 min-w-0 gap-[var(--order-mobile-inline,0.25rem)] rounded-[var(--order-mobile-radius,0.625rem)] px-[var(--order-mobile-pad,0.375rem)] text-[length:var(--order-mobile-meta,0.625rem)]",
            )}
            aria-pressed={active}
            title={option.label}
