            ...
            <PrintSection title="Intervento richiesto">
              <table className="repair-print-table">
                <thead>
                  <tr>
                    <th>Descrizione</th>
                    {!financeRedacted ? <th>Importo</th> : null}
                  </tr>
                </thead>
                <tbody>
          ...
          <aside className="repair-print-right">
            ...
            <section className="repair-print-warranty">
              ...
              <ul>
                ...
                <li>
                  Rotture successive di vetro touchscreen/LCD, ammaccature o crepe dovute a
                  incidenti o uso non corretto non sono coperte.
                </li>
                <li>
                  La garanzia non include software, account, dati personali, accessori non riparati
                  da noi o componenti non sostituiti.
                </li>
                <li>
