...
export async function sendNotification(id: string, input: OrderNotificationInput) {
  return postJson<OrderNotificationResult>("order/notification", { id, ...input });
}
...
export async function sendWhatsappNotification(
  ...
  return postJson<WhatsappNotificationResult>("order/whatsapp-notification", { id, ...input });
}
...
export async function updateCustomer(
  ...
  return postJson<{ ok: boolean; updated_at: string }>("customer/update", { id, input });
}
...
export async function upsertCustomerDevice(
  ...
  return postJson<{ id: string; updated_at: string }>("customer/device/upsert", {
    customerId,
    input,
  });
}
...
export async function deleteCustomerDevice(
  ...
  return postJson<{ ok: boolean }>("customer/device/delete", {
    customerId,
    deviceId,
    expected_updated_at,
  });
...
export async function setCustomerTags(
  ...
  return postJson<{ ok: boolean; updated_at: string }>("customer/tags/update", {
    customerId,
    ...input,
  });
}
