...
| DATA-20260718-005 | Inventory V2 production schema, RPC grants and V1/V2 reconciliation are not activated | Premature flags or bundled migration apply could expose unavailable commands or split inventory truth | Data + Security + Operations + Owner | follow `docs/INVENTORY_PRODUCT_V2_RELEASE_RUNBOOK.md` under a separate D4 approval | contained_by_pending_migrations_and_flags_off |
