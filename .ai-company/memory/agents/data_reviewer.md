...
# Agent Memory — `data_reviewer`

## Mission

Review schema invariants, migrations, backfills, performance, and recovery.

## Scope

- Capability domain: Data review
...
| RepairDesk local migration/data-domain map | C1 | `TASK-20260619-003/PROJECT_TAKEOVER_REPORT.md` | Integration Lead | 2026-06-19 |
