...
# Agent Memory — `release_reviewer`

## Mission

Review deployment, monitoring, rollback, migration, and operational readiness.

## Scope

- Capability domain: Release review
...
| RepairDesk CI/deploy readiness map | C1 | `TASK-20260619-003/PROJECT_TAKEOVER_REPORT.md` | Integration Lead | 2026-06-19 |
