...
# Agent Memory — `project_explorer`

## Mission

Map real files, symbols, dependencies, and execution paths with evidence.

## Scope

- Capability domain: Repository exploration
...
| RepairDesk repository takeover mapping | C2 | `.ai-company/memory/tasks/TASK-20260619-003/PROJECT_TAKEOVER_REPORT.md` | Integration Lead | 2026-06-19 |
