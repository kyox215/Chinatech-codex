...
status: active
capability_level: C2
permission: workspace-write (memory paths by policy)
autonomy: task-specific
last_evaluated_at: 2026-06-19
review_trigger: task-close-failure-or-quarterly
---

# Agent Memory — `memory_steward`

## Mission

Maintain task, project, department, decision, and capability memory with provenance.

## Scope

- Capability domain: Formal memory maintenance
- Default permission: workspace-write (memory paths by policy)
...
| RepairDesk task memory, checkpoints, evidence, conflicts, and project memory sync | C2 | `TASK-20260619-003/*`; `PROJECT_MEMORY.md`; `OPEN_CONFLICTS.md` | Integration Lead | 2026-06-19 |
