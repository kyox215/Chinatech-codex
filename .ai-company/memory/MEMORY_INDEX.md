...
- [TASK-20260901-002-site-i18n-optimization-release](tasks/TASK-20260901-002-site-i18n-optimization-release/TASK.md): Owner-approved release of the completed employee `zh-CN` / `it-IT` / `en` sequence through Memos, Toolkit, Platform and AI client. Targeted/module QA passes with direct-i18n P0/P1 zero; browser evidence retains a separate mobile overlay focus P2. Exact-scope preflight and release gates remain in progress.
...
- [TASK-20260720-002-platform-owner-approval](tasks/TASK-20260720-002-platform-owner-approval/TASK.md): Conditionally closed production platform-authority release; only verified `kyox120@gmail.com` can administer or approve at platform scope. Exact app SHA, migration, PostgreSQL 17 replay, Owner smoke, negative fixtures and immediate postchecks are recorded; extended observation and AAL2 hardening remain follow-ups.
