...
- [TASK-20260716-003-customer-finance-order-correction-plan](tasks/TASK-20260716-003-customer-finance-order-correction-plan/TASK.md): Customer history/valid-finance split, dual repair/payment states and audited terminal correction/reopen/Owner safe void; production migrations are applied and application release closeout is pending.
