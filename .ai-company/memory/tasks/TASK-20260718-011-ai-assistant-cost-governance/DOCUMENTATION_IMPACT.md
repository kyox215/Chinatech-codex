...
| Ops / Release | new variables fail closed; no enabled policy/apply/key; rollback preserves manual paths | `.env.example`, `RELEASE_PLAN.md`, canonical doc | provider-factory/runtime tests; release gates pending |
| QA | provider=0/local cloud=0, cost math, migration concurrency and regression matrix | `PHASE_PLAN.md`, `REVIEW_SYNTHESIS.md`, `EVIDENCE.md` | focused green; full/E2E pending |
