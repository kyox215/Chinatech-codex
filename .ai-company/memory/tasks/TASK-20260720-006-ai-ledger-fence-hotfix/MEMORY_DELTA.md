...
- **Fact:** forward migration `20260720065246` is locally validated but not production-applied. Source: linked history/dry-run and E-005 through E-011. Status: release candidate. Owner/scope: Integration Lead. Review trigger: Owner approval or newer `origin/main`.
...
- RELEASE: database hotfix is DB-only; do not bundle AI flags, Vision, policy, secrets or unrelated Vercel changes.
