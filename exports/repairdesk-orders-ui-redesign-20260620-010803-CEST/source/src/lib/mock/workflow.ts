...
export const DEFAULT_ORDER_WORKFLOW_TRANSITIONS: Record<string, RepairOrderStatus[]> = {
  ...
  mail_in_progress: ["repaired", "repairing", "diagnosing", "unfixed_pickup", "cancelled"],
  diagnosing: ["quoted", "repairing", "unfixed_pickup", "cancelled"],
  quoted: ["waiting_approval", "repairing", "parts_ordered", "mail_in_progress", "cancelled"],
  waiting_approval: ["repairing", "parts_ordered", "mail_in_progress", "cancelled"],
  parts_ordered: ["parts_arrived", "cancelled"],
  parts_arrived: ["repairing", "cancelled"],
  repairing: ["repaired", "mail_in_progress", "parts_ordered", "unfixed_pickup", "cancelled"],
