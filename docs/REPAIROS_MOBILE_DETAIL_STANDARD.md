...
订单详情与新建报价共用 12 类四列三行整格选择器：图标、短标签和箭头属于同一入口，选中显示主色与勾选。Owner 已选 A 的明确密度变体为 33px 分类目标、4px 行距，共107px；主要保存/取消操作保持44px，真实手机输入至少16px；卡内使用 8–10px 间距、短字段并排，不叠加内卡或明细内滚动。
