...
状态：设备资料能力已发布；方案 C 详情 UI 已完成并于 2026-07-30 获老板 D4 发布批准
...
- 首卡用类别图形、状态、品牌型号和 SKU 先回答“这是什么”，下方最多显示售价、有权限的成本、脱敏主标识和库位。
- “设备工作台”用两列/三列图标卡显示存储、RAM、颜色、成色、保修和类别规格；只显示 API 真实返回的值。
