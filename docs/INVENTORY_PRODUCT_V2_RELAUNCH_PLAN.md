...
> 已被2026-09-16老板最新指令替代：产品AI助手全面移除。本节仅保留当时设计记录，“禁止删除”不再约束助手运行源码；历史迁移、任务证据、秘密与既有数据仍按原边界保留。本地OCR、条码与IMEI确定性校验继续使用。当前执行与发布限制见[重构发布说明](REFACTOR_RELEASE_2026-09-16.md)。
