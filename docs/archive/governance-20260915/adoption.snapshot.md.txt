...
AI Company OS version: 3.0.0 Codex Native Edition + One Command Mode v3.2
Last verified: 2026-07-01 CEST

This file connects AI Company OS Codex Native v3.0 and One Command Mode v3.2 to the existing RepairDesk repository rules. It is an adapter layer, not a replacement for the root `AGENTS.md` or the RepairDesk department system.
...
- One Command Mode: `.ai-company/ONE_COMMAND_MODE.md`, used as the long-form reference for natural-language Owner task intake.
...
2. Root `AGENTS.md`.
3. `.ai-company/ONE_COMMAND_MODE.md` when interpreting Owner Simple Mode and natural-language task intake.
4. `AI智能部门管理/部门化管理设计.md` and `.agents/*`.
5. Existing RepairDesk architecture, UI, component, responsive, mobile, data, and security docs.
6. This adapter file.
7. Generic `.ai-company/policies/*` rules.
8. `.ai-company/memory/*` verified/approved records.
9. Existing code patterns.
10. Individual agent preference.
...
3. `.ai-company/ONE_COMMAND_MODE.md`.
4. `.ai-company/policies/CODEX_OPERATING_MODEL.md`.
5. `.ai-company/policies/PROJECT_RULES.md`.
6. `.ai-company/policies/TASK_FLOW.md`.
7. `.ai-company/memory/ACTIVE_CONTEXT.md`.
8. `AI智能部门管理/部门化管理设计.md`.
9. Relevant `.agents/*` files when the task uses departments, skills, or sub-agents.
10. Relevant RepairDesk architecture, UI, API, data, and test files for the actual task.
...
The owner may give a short natural-language instruction; this is the formal task input under One Command Mode. Do not ask the owner to fill internal templates, choose agents, or maintain memory. If the task is non-trivial, the Integration Lead derives:
...
Write the full task contract to `.ai-company/memory/tasks/<task_id>/`; keep the main chat to task receipt, necessary decisions, real blockers, and final closeout.
